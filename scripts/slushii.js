...
// Clickable Dropdown
function clickable() {
  document.querySelectorAll("clickable-dropdown").classList.toggle("clickable-dropdown-show");
}

window.onclick = function(event) {
  if (!event.target.matches('.clickable-dropbutton')) {
    let dropdowns = document.querySelectorAll("clickable-dropdown-content");
    let i;
...
// Flyout menu 1
function flyout() {
  document.querySelectorAll("flyout-dropdown").classList.toggle("flyout-dropdown-show");
}
